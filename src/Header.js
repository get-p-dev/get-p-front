        ...
        <div className="w-full bg-white sticky top-0 z-10">
            <div className="max-w-4xl mx-auto px-10 pt-3 pb-3">
                <div className="flex flex-row gap-8 items-center justify-center w-full">
                    <Link to="/" className="flex justify-center items-center gap-2 text-3xl font-md pl-2 pr-4 text-gray-900 rounded-2xl bg-white"><img className="w-20 aspect-auto" src={logo} alt="logo" />Get-P</Link>
                    <input
