                ...
                <div className="py-10 rounded-md flex flex-col gap-8 max-w-2xl w-full ">
                    ...
                    <form className="w-full flex flex-col gap-6" onSubmit={(e) => {
                        ...
                        <label>
                            ...
                            <input className="w-full border-2 border-gray-200 rounded-2xl px-6 py-4 border-" type="text" name="id" placeholder="email@website.com" onChange={e => setEmail(e.target.value)} />
                        </label>
                        <label>
                            <h3 className="text-xl font-bold px-2 mb-2">
                                비밀번호
                            </h3>
                            <input className="w-full border-2 border-gray-200 rounded-2xl px-6 py-4" type="password" name="password" placeholder="비밀번호를 입력하세요." onChange={e => setPassword(e.target.value)} />
                        </label>
